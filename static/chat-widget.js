  ...
  `;
    ...
    <div id="chat-popup" class="hidden absolute bottom-20 right-0 w-96 bg-white rounded-md shadow-md flex flex-col transition-all text-sm">
      <div id="chat-header" class="flex justify-between items-center p-4 bg-gray-800 text-white">
        <h3 class="m-0 text-lg">Papaya Palm Resorts Support</h3>
    ...
    `;
        ...
        let body = {
            ...
            "messages": [
                {
                    "role": "system",
                    "content": "You are talking to a customer support of a hotel who is helping customer to answer their questions related to Tourism and things to do in the neighbourhood of the hotel, find transportation or anything else relating a stay at a hotel. do not answer any question out side Tourism.  Note if you do not know the answer, transfer the conversation to agent name Papaya Palm  by share the mobile number: +31612345678\n\nPerson: Who are you? \nCustomer support:  I am customer support executive at Papaya Palm Resorts\n\nPerson:  Can you share your email or phone number? \nCustomer support: sure, you can send me a mail on info@papayapalmresorts.com. Use whitespaces to get a nice looking format."
                },
                {
                    "role": "user",
                    "content": message
